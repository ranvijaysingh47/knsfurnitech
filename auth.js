            ...
            slot.innerHTML = `
              <div class="kns-profile-wrap">
                ...
                <div class="kns-profile-dropdown" id="knsProfileDropdown">
                  ...
                  <a href="track-order.html" class="kns-pd-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect width="16" height="13" x="1" y="3" rx="2"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
                    Track Order
                  </a>
